...
namespace ls
{
	...
	public:
		...
		{
			return LS_THREAD_CURRENT_ID == ownerThread;
		}
	...
	class LS_CORE_EXPORT CommandQueueBase
	{
	public:
		/**
		 * Constructor.
	...
	public:
		...
		ls::Queue<QueuedCommand>* flush()
		{
			...
			this->lock();
			ls::Queue<QueuedCommand>* commands = CommandQueueBase::flush();
			this->unlock();
