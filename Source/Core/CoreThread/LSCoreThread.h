...
namespace ls
{
	...
	LS_FLAGS_OPERATORS(CoreThreadQueueFlag)
	 ...
	 */
	class LS_CORE_EXPORT CoreThread : public Module<CoreThread>
	{
		...
		struct QueueData
		{
			static LS_THREADLOCAL ThreadQueueContainer* current;
		};
