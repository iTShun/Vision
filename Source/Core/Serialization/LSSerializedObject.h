...
namespace ls
{
	...
	struct SerializedInstance : public IReflectable
	{
	...
	struct SerializedEntry : IReflectable
	{
	...
	struct SerializedSubObject : IReflectable
	{
	 ...
	 */
	struct SerializedObject : public SerializedInstance
	{
	...
	struct SerializedField : SerializedInstance
	{
	...
	struct SerializedDataBlock : SerializedInstance
	{
	...
	struct SerializedArrayEntry : IReflectable
	{
	...
	struct SerializedArray : SerializedInstance
	{
