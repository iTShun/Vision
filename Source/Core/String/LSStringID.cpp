...
namespace ls
{
	...
	template void StringID::construct(const char* const&);
	template void StringID::construct(String const&);
	
	template UINT32 StringID::calcHash(const char* const&);
	template UINT32 StringID::calcHash(String const&);
}
