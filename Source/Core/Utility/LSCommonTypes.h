...
#undef Convex
	...
	enum LS_SCRIPT_EXPORT(n:MeshTopology,m:Rendering) DrawOperationType
	{
		/** Each vertex represents a point. */
		DOT_POINT_LIST		LS_SCRIPT_EXPORT(n:PointList)		= 1,
		/** Each sequential pair of vertices represent a line. */
		DOT_LINE_LIST		LS_SCRIPT_EXPORT(n:LineList)		= 2,
		/** Each vertex (except the first) forms a line with the previous vertex. */
		DOT_LINE_STRIP		LS_SCRIPT_EXPORT(n:LineStrip)		= 3,
		/** Each sequential 3-tuple of vertices represent a triangle. */
		DOT_TRIANGLE_LIST	LS_SCRIPT_EXPORT(n:TriangleList)	= 4,
		/** Each vertex (except the first two) form a triangle with the previous two vertices. */
		DOT_TRIANGLE_STRIP	LS_SCRIPT_EXPORT(n:TriangleStrip)	= 5,
		/** Each vertex (except the first two) form a triangle with the first vertex and previous vertex. */
		DOT_TRIANGLE_FAN	LS_SCRIPT_EXPORT(n:TriangleFan)		= 6
	};

	/**	Type of mesh indices used, used for determining maximum number of vertices in a mesh. */
	enum LS_SCRIPT_EXPORT(m:Rendering) IndexType
	{
		IT_16BIT	LS_SCRIPT_EXPORT(n:Index16),	/**< 16-bit indices. */
		IT_32BIT	LS_SCRIPT_EXPORT(n:Index32)		/**< 32-bit indices. */
	};
	...
	enum GpuBufferFormat
	{
		...
		BF_COUNT, /**< Not a valid format. Keep just before LS_UNKNOWN. */
	...
	enum LS_SCRIPT_EXPORT(m:Rendering) TextureType
	{
		/** One dimensional texture. Just a row of pixels. */
		TEX_TYPE_1D			LS_SCRIPT_EXPORT(n:Texture1D)	= 1, 
		/** Two dimensional texture. */
		TEX_TYPE_2D			LS_SCRIPT_EXPORT(n:Texture2D)	= 2,
		/** Three dimensional texture. */
		TEX_TYPE_3D			LS_SCRIPT_EXPORT(n:Texture3D)	= 3,
		/** Texture consisting out of six 2D textures describing an inside of a cube. Allows special sampling. */
		TEX_TYPE_CUBE_MAP	LS_SCRIPT_EXPORT(n:TextureCube) = 4 
	};

	/**	Projection type to use by the camera. */
	enum LS_SCRIPT_EXPORT() ProjectionType
	{ 
		/** Projection type where object size remains constant and parallel lines remain parallel. */
		PT_ORTHOGRAPHIC		LS_SCRIPT_EXPORT(n:Orthographic),
		/** Projection type that emulates human vision. Objects farther away appear smaller. */
		PT_PERSPECTIVE		LS_SCRIPT_EXPORT(n:Perspective)
	};
	...
	LS_FLAGS_OPERATORS(ShaderFlag)

	/** Valid types of a mesh used for physics. */
	enum class LS_SCRIPT_EXPORT() PhysicsMeshType
	{
		/** 
	...
	LS_FLAGS_OPERATORS(RenderSurfaceMaskBits);
	 ...
	 */
	enum class LS_SCRIPT_EXPORT() ObjectMobility
	{
	...
	struct LS_SCRIPT_EXPORT(m:Rendering,pl:true) TextureSurface
	{
		...
		static LS_CORE_EXPORT const TextureSurface COMPLETE;
	};
	...
	LS_ALLOW_MEMCPY_SERIALIZATION(TextureSurface);
	/** @endcond */
