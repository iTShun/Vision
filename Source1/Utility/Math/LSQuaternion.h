...
namespace ls
{
	...
	class LS_UTILITY_EXPORT Quaternion
	{
	private:
	...
	public:
		...
		constexpr Quaternion(LS_ZERO zero)
			: x(0.0f), y(0.0f), z(0.0f), w(0.0f)
		{ }

		constexpr Quaternion(LS_IDENTITY)
	...
	LS_ALLOW_MEMCPY_SERIALIZATION(Quaternion);
	/** @endcond */
}
...
namespace std 
{
	template<> class numeric_limits<ls::Quaternion> 
	{
	public:
		constexpr static ls::Quaternion infinity() 
		{
			return ls::Quaternion(
