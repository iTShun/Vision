...
namespace ls
{
	...
	class LS_UTILITY_EXPORT Vector3
	{
	public:
		float x, y, z;
	...
	LS_ALLOW_MEMCPY_SERIALIZATION(Vector3);
	/** @endcond */
} 
...
namespace std 
{
	template<> class numeric_limits<ls::Vector3> 
	{
	public:
		constexpr static ls::Vector3 infinity() 
		{
			return ls::Vector3(
