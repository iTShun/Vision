...
#	define LS_CDECL			__attribute__((cdecl))
#	define LS_FALLTHROUGH	[[clang::fallthrough]];
#elif COMPILER_GCC
#	define LS_THREADLOCAL	__thread
#	define LS_STDCALL		__attribute__((stdcall))
#	define LS_CDECL			__attribute__((cdecl))
#	define LS_FALLTHROUGH	__attribute__((fallthrough));
#elif COMPILER_MSVC
#	define LS_THREADLOCAL	__declspec(thread)
#	define LS_STDCALL		__stdcall
#	define LS_CDECL			__cdecl
#	define LS_FALLTHROUGH
...
#if PLATFORM_WINDOWS
#	if COMPILER_MSVC
#		if defined(LS_STATIC_LIB)
#			define LS_UTILITY_EXPORT
#		else
#			if defined(LS_UTILITY_EXPORTS)
#				define LS_UTILITY_EXPORT __declspec(dllexport)
#			else
#				define LS_UTILITY_EXPORT __declspec(dllimport)
#			endif
#		endif
#		define LS_PLUGIN_EXPORT __declspec(dllexport)
#	else
#		if defined(LS_STATIC_LIB)
#			define LS_UTILITY_EXPORT
#		else
#			if defined(LS_UTILITY_EXPORTS)
#				define LS_UTILITY_EXPORT __attribute__ ((dllexport))
#			else
#				define LS_UTILITY_EXPORT __attribute__ ((dllimport))
#			endif
#		endif
#		define LS_PLUGIN_EXPORT __attribute__ ((dllexport))
#	endif
#	define LS_UTILITY_HIDDEN
#elif PLATFORM_IOS || PLATFORM_OSX || PLATFORM_LINUX
#	define LS_UTILITY_EXPORT __attribute__ ((visibility ("default")))
#	define LS_UTILITY_HIDDEN __attribute__ ((visibility ("hidden")))
#	define LS_PLUGIN_EXPORT __attribute__ ((visibility ("default")))
#endif
