...
#include "Serialization/LSSerializedObject.h"
...
namespace ls
{
	...
	class LS_UTILITY_EXPORT SerializedInstanceRTTI : public RTTIType <SerializedInstance, IReflectable, SerializedInstanceRTTI>
	{
	public:
	...
	class LS_UTILITY_EXPORT SerializedFieldRTTI : public RTTIType <SerializedField, SerializedInstance, SerializedFieldRTTI>
	{
	private:
		SPtr<DataStream> getData(SerializedField* obj, UINT32& size)
		{
			...
			return ls_shared_ptr_new<MemoryDataStream>(obj->value, obj->size, false);
		}

		void setData(SerializedField* obj, const SPtr<DataStream>& value, UINT32 size)
		{
			obj->value = (UINT8*)ls_alloc(size);
			obj->size = size;
			obj->ownsMemory = true;
	...
	public:
		...
		SPtr<IReflectable> newRTTIObject() override
		{
			return ls_shared_ptr_new<SerializedField>();
		}
	};

	class LS_UTILITY_EXPORT SerializedDataBlockRTTI : public RTTIType <SerializedDataBlock, SerializedInstance, SerializedDataBlockRTTI>
	{
	private:
		...
		void setData(SerializedDataBlock* obj, const SPtr<DataStream>& value, UINT32 size)
		{
			...
			SPtr<MemoryDataStream> memStream = ls_shared_ptr_new<MemoryDataStream>(data, size);
	...
	public:
		...
		SPtr<IReflectable> newRTTIObject() override
		{
			return ls_shared_ptr_new<SerializedDataBlock>();
		}
	};

	class LS_UTILITY_EXPORT SerializedObjectRTTI : public RTTIType <SerializedObject, SerializedInstance, SerializedObjectRTTI>
	{
	private:
	...
	public:
		...
		SPtr<IReflectable> newRTTIObject() override
		{
			return ls_shared_ptr_new<SerializedObject>();
		}
	};

	class LS_UTILITY_EXPORT SerializedArrayRTTI : public RTTIType <SerializedArray, SerializedInstance, SerializedArrayRTTI>
	{
	private:
	...
	public:
		...
		SPtr<IReflectable> newRTTIObject() override
		{
			return ls_shared_ptr_new<SerializedArray>();
		}
	...
	class LS_UTILITY_EXPORT SerializedSubObjectRTTI : public RTTIType <SerializedSubObject, IReflectable, SerializedSubObjectRTTI>
	{
	private:
	...
	public:
		...
		SPtr<IReflectable> newRTTIObject() override
		{
			return ls_shared_ptr_new<SerializedSubObject>();
		}
	...
	class LS_UTILITY_EXPORT SerializedEntryRTTI : public RTTIType <SerializedEntry, IReflectable, SerializedEntryRTTI>
	{
	private:
	...
	public:
		...
		SPtr<IReflectable> newRTTIObject() override
		{
			return ls_shared_ptr_new<SerializedEntry>();
		}
	};

	class LS_UTILITY_EXPORT SerializedArrayEntryRTTI : public RTTIType <SerializedArrayEntry, IReflectable, SerializedArrayEntryRTTI>
	{
	private:
	...
	public:
		...
		SPtr<IReflectable> newRTTIObject() override
		{
			return ls_shared_ptr_new<SerializedArrayEntry>();
		}
	};
