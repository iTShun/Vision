...
namespace ls
{
	...
	struct LS_UTILITY_EXPORT SerializedInstance : IReflectable
	{
	...
	struct LS_UTILITY_EXPORT SerializedEntry : IReflectable
	{
	...
	struct LS_UTILITY_EXPORT SerializedSubObject : IReflectable
	{
	 ...
	 */
	struct LS_UTILITY_EXPORT SerializedObject : SerializedInstance
	{
	...
	struct LS_UTILITY_EXPORT SerializedField : SerializedInstance
	{
	...
	struct LS_UTILITY_EXPORT SerializedDataBlock : SerializedInstance
	{
	...
	struct LS_UTILITY_EXPORT SerializedArrayEntry : IReflectable
	{
	...
	struct LS_UTILITY_EXPORT SerializedArray : SerializedInstance
	{
