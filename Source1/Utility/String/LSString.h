...
namespace ls
{
	...
	class LS_UTILITY_EXPORT StringUtil
	{
	public:
	...
	LS_UTILITY_EXPORT WString toWString(const String& source);

	/**	Converts a narrow string to a wide string. */
	LS_UTILITY_EXPORT WString toWString(const char* source);

	/** Converts a float to a string. */
	LS_UTILITY_EXPORT WString toWString(float val, unsigned short precision = 6, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/** Converts a double to a string. */
	LS_UTILITY_EXPORT WString toWString(double val, unsigned short precision = 6, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/** Converts a Radian to a string. */
	LS_UTILITY_EXPORT WString toWString(Radian val, unsigned short precision = 6, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/** Converts a Degree to a string. */
	LS_UTILITY_EXPORT WString toWString(Degree val, unsigned short precision = 6, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/**	Converts an int to a string. */
	LS_UTILITY_EXPORT WString toWString(int val, unsigned short width = 0, 
		char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/**	Converts an unsigned int to a string. */
	LS_UTILITY_EXPORT WString toWString(unsigned int val, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/**	Converts an 64bit integer to a string. */
	LS_UTILITY_EXPORT WString toWString(INT64 val, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/**	Converts an 64bit unsigned to a string. */
	LS_UTILITY_EXPORT WString toWString(UINT64 val, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/**	Converts an narrow char unsigned to a string. */
	LS_UTILITY_EXPORT WString toWString(char val,
		unsigned short width = 0, char fill = ' ',
		std::ios::fmtflags flags = std::ios::fmtflags(0));

	/**	Converts an wide bit char unsigned to a string. */
	LS_UTILITY_EXPORT WString toWString(wchar_t val,
		unsigned short width = 0, char fill = ' ',
		std::ios::fmtflags flags = std::ios::fmtflags(0));
	 ...
	 */
	LS_UTILITY_EXPORT WString toWString(bool val, bool yesNo = false);
	 ...
	 * @note	Format is "x y".
	 */
	LS_UTILITY_EXPORT WString toWString(const Vector2& val);
	 ...
	 * @note	Format is "x y".
	 */
	LS_UTILITY_EXPORT WString toWString(const Vector2I& val);
	 ...
	 */
	LS_UTILITY_EXPORT WString toWString(const Vector3& val);
	 ...
	 */
	LS_UTILITY_EXPORT WString toWString(const Vector4& val);
	 ...
	 */
	LS_UTILITY_EXPORT WString toWString(const Matrix3& val);
	 ...
	 */
	LS_UTILITY_EXPORT WString toWString(const Matrix4& val);
	 ...
	 */
	LS_UTILITY_EXPORT WString toWString(const Quaternion& val);
	 ...
	 */
	LS_UTILITY_EXPORT WString toWString(const Color& val);

	/** Converts a vector of strings into a single string where the substrings are delimited by spaces. */
	LS_UTILITY_EXPORT WString toWString(const Vector<ls::WString>& val);

	/** Converts a wide string to a narrow string. */
	LS_UTILITY_EXPORT String toString(const WString& source);

	/**	Converts a wide string to a narrow string. */
	LS_UTILITY_EXPORT String toString(const wchar_t* source);

	/**	Converts a float to a string. */
	LS_UTILITY_EXPORT String toString(float val, unsigned short precision = 6, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/**	Converts a double to a string. */
	LS_UTILITY_EXPORT String toString(double val, unsigned short precision = 6, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/**	Converts a Radian to a string. */
	LS_UTILITY_EXPORT String toString(Radian val, unsigned short precision = 6, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/**	Converts a Degree to a string. */
	LS_UTILITY_EXPORT String toString(Degree val, unsigned short precision = 6, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/**	Converts an int to a string. */
	LS_UTILITY_EXPORT String toString(int val, unsigned short width = 0, 
		char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/**	Converts an unsigned int to a string. */
	LS_UTILITY_EXPORT String toString(unsigned int val, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/**	Converts a 64bit int to a string. */
	LS_UTILITY_EXPORT String toString(INT64 val, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );

	/**	Converts an 64bit unsigned int to a string. */
	LS_UTILITY_EXPORT String toString(UINT64 val, 
		unsigned short width = 0, char fill = ' ', 
		std::ios::fmtflags flags = std::ios::fmtflags(0) );
	 ...
	 * @param[in]	yesNo	(optional) If set to true, result is "yes" or "no" instead of "true" or "false".
	 */
	LS_UTILITY_EXPORT String toString(bool val, bool yesNo = false);
	 ...
	 * @note	Format is "x y".
	 */
	LS_UTILITY_EXPORT String toString(const Vector2& val);
	 ...
	 * @note	Format is "x y".
	 */
	LS_UTILITY_EXPORT String toString(const Vector2I& val);
	 ...
	 * @note	Format is "x y z".
	 */
	LS_UTILITY_EXPORT String toString(const Vector3& val);
	 ...
	 * @note	Format is "x y z w".
	 */
	LS_UTILITY_EXPORT String toString(const Vector4& val);
	 ...
	 * @note	Format is "00 01 02 10 11 12 20 21 22".
	 */
	LS_UTILITY_EXPORT String toString(const Matrix3& val);
	 ...
	 * @note	Format is "00 01 02 03 10 11 12 13 20 21 22 23 30 31 32 33".
	 */
	LS_UTILITY_EXPORT String toString(const Matrix4& val);
	 ...
	 * @note	Format is "w x y z".
	 */
	LS_UTILITY_EXPORT String toString(const Quaternion& val);
	 ...
	 * @note	Format is "r g b a".
	 */
	LS_UTILITY_EXPORT String toString(const Color& val);

	/**
	 * Converts a vector of strings into a single string where the substrings are delimited by spaces.
	 */
	LS_UTILITY_EXPORT String toString(const Vector<ls::String>& val);
	 ...
	 */
	LS_UTILITY_EXPORT float parseFloat(const String& val, float defaultValue = 0);
	 ...
	 */
	LS_UTILITY_EXPORT INT32 parseINT32(const String& val, INT32 defaultValue = 0);
	 ...
	 * @note	0 if the value could not be parsed, otherwise the numeric version of the string.
	 */
	LS_UTILITY_EXPORT UINT32 parseUINT32(const String& val, UINT32 defaultValue = 0);
	 ...
	 * @note	0 if the value could not be parsed, otherwise the numeric version of the string.
	 */
	LS_UTILITY_EXPORT INT64 parseINT64(const String& val, INT64 defaultValue = 0);
	 ...
	 * @note	0 if the value could not be parsed, otherwise the numeric version of the string.
	 */
	LS_UTILITY_EXPORT UINT64 parseUINT64(const String& val, UINT64 defaultValue = 0);
	 ...
	 *			false otherwise.
	 */
	LS_UTILITY_EXPORT bool parseBool(const String& val, bool defaultValue = 0);

	/** Checks the String is a valid number value. */
	LS_UTILITY_EXPORT bool isNumber(const String& val);
	 ...
	 * @note	0.0f if the value could not be parsed, otherwise the numeric version of the string.
	 */
	LS_UTILITY_EXPORT float parseFloat(const WString& val, float defaultValue = 0);
	 ...
	 * @note	0 if the value could not be parsed, otherwise the numeric version of the string.
	 */
	LS_UTILITY_EXPORT INT32 parseINT32(const WString& val, INT32 defaultValue = 0);
	 ...
	 * @note	0 if the value could not be parsed, otherwise the numeric version of the string.
	 */
	LS_UTILITY_EXPORT UINT32 parseUINT32(const WString& val, UINT32 defaultValue = 0);
	 ...
	 * @note	0 if the value could not be parsed, otherwise the numeric version of the string.
	 */
	LS_UTILITY_EXPORT INT64 parseINT64(const WString& val, INT64 defaultValue = 0);
	 ...
	 * @note	0 if the value could not be parsed, otherwise the numeric version of the string.
	 */
	LS_UTILITY_EXPORT UINT64 parseUINT64(const WString& val, UINT64 defaultValue = 0);
	 ...
	 */
	LS_UTILITY_EXPORT bool parseBool(const WString& val, bool defaultValue = 0);

	/**
	 * Checks the WString is a valid number value.
	 */
	LS_UTILITY_EXPORT bool isNumber(const WString& val);
	...
	void LS_UTILITY_EXPORT __string_throwDataOverflowException();
	...
	{	
		...
		{ 
			...
			char* buffer = (char*)ls_alloc(stringSize + 1);
	...
	{	
		...
		{ 
			...
			UINT32 stringSize = size - sizeof(UINT32);
			WString::value_type* buffer = (WString::value_type*)ls_alloc(stringSize + sizeof(WString::value_type));
			memcpy(buffer, memory, stringSize); 
...
template<> 
struct hash<ls::String>
{
	size_t operator()(const ls::String& string) const
	{
		size_t hash = 0;
...
template<> 
struct hash<ls::WString>
{
	size_t operator()(const ls::WString& string) const
	{
		size_t hash = 0;
		for(size_t i = 0; i < string.size(); i++) 
			hash = 65599 * hash + string[i];
