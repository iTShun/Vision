...
namespace ls
{
	...
	class LS_UTILITY_EXPORT HThread
	{
	public:
		HThread() = default;;
	...
	class LS_UTILITY_EXPORT PooledThread
	{
	public:
	 ...
	 */
	class LS_UTILITY_EXPORT ThreadPool : public Module<ThreadPool>
	{
	public:
		/**
	...
	protected:
		...
		{
			PooledThread* newThread = ls_new<TPooledThread<ThreadPolicy>>(name);
