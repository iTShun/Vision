...
# define _REFERENCED_USE_ATOMIC_OPERATIONS
#endif
...
public:
    ...
    /** Get the optional global Referenced mutex, this can be shared between all core::Referenced.*/
